...
All vehicles are to be delivered to <marker name='fob_cuprum'>FOB Cuprum</marker>."],
		...
		["Situation",
			"October 19th 2024: welcome to Greece, Private Military Company Versus. The reason behind Versus presence on Altis is a contract made with the Takistani militia group Al-Azif. 
The assignment is simple: PMC Versus is to establish a covert base on the island and use all means imaginable to destabilize the Altian government for the next eight months. To what end, 
the contract does not say. The commission for this whole operation is 4.2 million euros.<br/><br/>PMC Versus is doing good financially, but smuggling military equipment to Altis has been 
unsuccessful thus far because of the heavy presence of Altian Armed Forces (AAF) along the coast. PMC Versus high command, however, made a deal with an Altian extremist group, Nekron Chelia. 
The group saw Versus operators as an aid to their cause for 'freedom in Altis' and promised to supply Versus with weapons and equipment. After negotiating the co-operation details between Versus 
and Nekron Chelia, Versus local <marker name='fob_aurum'>high command</marker> on Altis (callsign 'Corona') has evaluated the group's methods unsatisfactory. The extremists are reluctant to use 
their weapons againts Altian citizens or the AAF forces and haven't delivered the weapons and explosives they promised. Instead, the Nekron Chelia courier has delived Versus 
<marker name='perditus_start'>operators</marker> (callsign 'Perditus') ancient pre-2000 weapons and not nearly enough ammunition.<br/><br/>Corona wants Versus operators to eliminate the whole 
...
additional Versus <marker name='derelictus_start'>team</marker> (callsign 'Derelictus') to help Perditus eliminate the weapon <marker name='obj1'>courier</marker> and the NC 
...
All vehicles are to be delivered to the newly established <marker name='fob_cuprum'>FOB Cuprum</marker> which serves as a base to Perditus."],
		...
		["Enemy",
			"Although the Nekron Chelia fighters are expecting to work alongside PMC Versus, an armed approach will most likely result in a firefight since Versus is not supposed to make 
...
is still unknown. All Versus personnel in the area have already changed uniforms to blend in with the NC and Corona reminds Perditus and Derelictus to double check their targets before 
